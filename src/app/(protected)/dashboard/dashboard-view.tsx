...
import { TodaySchedule, type GroupedDoseEntries } from "@/components/dashboard/today-schedule";

export type DashboardViewProps = {
  userName: string;
  supplementCount: number;
  searchCount: number;
  todaysSchedule: GroupedDoseEntries;
  takenEntryIds: string[];
                  ...
                  return (
                    <Link key={action.href} href={action.href}>
                      <div className="flex items-center gap-3 p-4 rounded-xl bg-slate-800/30 
                        ...
                        hover:bg-slate-800/50 transition-[background-color,border-color,color,transform,box-shadow] cursor-pointer group">
